        ...
        bot.click()
        if not bot.find( "crm_relativo_10_ecommerce_exibir_lista", matching=0.97, waiting_time=10000):
            not_found("crm_relativo_10_ecommerce_exibir_lista")
        bot.click_relative(-108, 71)
        ...
        bot.click()
        if not bot.find( "crm_btn_excluir_spc_clientes", matching=0.97, waiting_time=10000):
            not_found("crm_btn_excluir_spc_clientes")
        bot.click()
