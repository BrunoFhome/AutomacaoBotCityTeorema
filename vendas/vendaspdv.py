...
"""
CÓDIGO FEITO PARA SISTEMA VENDAS PDV 23.07
...
#COMEÇO DE VENDAS
        ...
        #self.find_button( "botao_vendas_menu")
        self.find_button( "23_vendas_menu_1" )
        self.click()
        ...
        self.find_button( "23_selecionar_observacao" )
            #("23_selecionar_observacao")
        self.click()
        self.wait(1000)
        ...
        self.tab()
        self.enter()
        # nao usar por enquanto, testando finalizacao da nota
        #self.find_button( "botao_sair_finalizar_orcamento_2" ) 
        #    #("botao_sair_finalizar_orcamento_2")
        #self.click()


        ######## NÃO ESTOU CONSEGUINDO EMITIR A NOTA FISCAL 24/04
        ...
        #
        #
        self.find_button( "23_selecionar_nfe_class" )
            #("23_selecionar_nfe_class")
        self.click()
        ...
        ###
        self.find_button( "23_botao_gravas_nota_fiscal" )
            #("23_botao_gravas_nota_fiscal")
        self.click()
        self.wait(1000)
        ...
        self.wait(1000)
        #
        self.find_button( "23_entregas_vendas" )
            #("23_entregas_vendas")
        self.click()
        ...
        self.type_keys_with_interval(1,'123')
        self.tab()
        self.find_button( "achar_data_rel_entreg")
        ...
        self.click()
        self.find_button( "buscar_cliente_botao_entrega")
           
        self.click()
        self.wait(4000)
        self.type_keys_with_interval(1,'0000001')
        self.wait(1000)
        self.find_button( "localizar_entrega_botao_cliente")
        ...
        self.find_button( "retorn_de_entregas_temp")
...
######################### AQUI ESTA O TAMANHO DA FOLHA  ##################
       ...
       # self.wait(2000)
        ...
        if not self.find( "vendas_botao_pdv_mais", matching=0.97, waiting_time=10000):
            not_found("vendas_botao_pdv_mais")
        self.click()
        self.wait(4000)
        ...
        ####
        self.find_button( "23_botao_documentos_vendas" )
            #("23_botao_documentos_vendas")
        self.click()
...
#######################  F7 FINANCEIRO   ######################
        ...
        #
        #
        self.find_button( "grupo_empresas_rel_filtro_loc_2")
            ##("grupo_empresas_rel_filtro_loc_2")
        self.click_relative(120, 81)
        self.wait(2000)
        self.find_button( "filtro_relativo_grupo_empresas_selc_2")
            ##("filtro_relativo_grupo_empresas_selc_2")
        self.click_relative(196, 82)
        ...
        self.wait(1000)
        self.find_button( "filtro_relatiivo_moeda_localizar")
            ##("filtro_relatiivo_moeda_localizar")
        self.click_relative(120, 83)
        self.wait(1000)
        self.find_button( "filtro_relativo_moeda_selec_f7")
            ##("filtro_relativo_moeda_selec_f7")
        self.click_relative(195, 84)
    ...
    ########################   F8 SIMULAÇÃO ######################
        ...
        self.find_button( "23_f8_simulacao_vendas" )
            #("23_f8_simulacao_vendas")
        self.click()
...
#########  F11 RECUPERAR VENDAS  ###########
        ...
        self.find_button( "23_f11_recuperar_vendas" )
            #("23_f11_recuperar_vendas")
        self.click()
...
#####################################################################################################
#para mim, a consulta nao esta abrindo, deixar como comentario ate consertar
...
################ CADASTROS #####################
################################################
        self.find_button( "23_cadastros_menu" )
            #("23_cadastros_menu")
        self.click()
        ...
        if not self.find( "vendas_pdv_botao_excluir_municipio", matching=0.97, waiting_time=10000):
            not_found("vendas_pdv_botao_excluir_municipio")
        self.click()
...
################### CADASTRO DE GRUPOS DE O.S  ######################
        ...
        self.find_button( "23_chamadas_menu" )
            #("23_chamadas_menu")
        self.click()
        ...
        #self.click()
         #
          #
           #
            #
        self.find_button( "23_retornar_chamadas_anexo" )
            #("23_retornar_chamadas_anexo")
        self.click()
...
####################################################################
        ...
        self.type_keys_with_interval(1,"123")
        self.tab()
        self.find_button( "relativo_com_data_30_doce" ) 
            #("relativo_com_data_30_doce")
        ...
        self.click()
        self.wait(1000)
        self.find_button( "codigo_selecionar_cliente_filtro_doc" ) 
            #("codigo_selecionar_cliente_filtro_doc")
        self.click_relative(-28, 25)
        
        self.wait(1000)
        self.find_button( "padrao_de_busca_filtro_doce" ) 
            #("padrao_de_busca_filtro_doce")
        self.click_relative(8, 35)
        self.wait(500)
        self.type_right()
        self.type_right()
        self.find_button( "achar_qualquer_posicao_botao_relativo_filtro" ) 
            #("achar_qualquer_posicao_botao_relativo_filtro")
        self.click_relative(-70, 7)
...
#############################################################################################
        ...
        self.click()
        self.wait(500)
        self.find_button( "solicitante_abrir_flecha_opc" ) 
            #("solicitante_abrir_flecha_opc")
        self.click_relative(226, 34)
        # errando clique relativo aqui, arrumar
        #
        #
        self.wait(500)
...
###### ALGUMAS OPÇÕES PARECEM ESTAR DESABILITADAS PARA USO
        ...
        self.click()
        self.find_button( "veiculo_rel_cliente_bot_busc" ) 
            #("veiculo_rel_cliente_bot_busc")
        self.click_relative(28, 31)
        ...
        self.click()
        self.wait(1000)
        self.find_button( "relativo_veiculo_pecas_placa_busc" ) 
            #("relativo_veiculo_pecas_placa_busc")
        self.click_relative(-17, 30)
        self.wait(2000)
        ...
        #MEXER EM CAIXA, (ABERTO DESDE 17/05)
        self.wait(2000)
